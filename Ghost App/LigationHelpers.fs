...
let oligoStamp (scale : float) : (string * float * float * float * float * float * float * string * float) = 
    match scale with
        |6.0 -> ("2.4", 2.4, 2.0, 6.0, 1.0, 5.7, 0.5,  "17.6", 17.6)
        |7.5 -> ("3", 3.0, 2.5, 7.5, 1.25, 7.125, 0.625, "22", 22.0) 
        |9.0 -> ("3.6", 3.6, 3.0, 9.0, 1.5, 8.55, 0.75, "26.4", 26.4)  
        |10.5 -> ("4.2", 4.2, 3.5, 10.5, 1.75, 9.975, 0.875, "30.8", 30.8) 
        |12.0 -> ("4.8", 4.8, 4.0, 12.0, 2.0, 11.4, 1.0, "35.2", 35.2)
        |13.5 -> ("5.4", 5.4, 4.5, 13.5, 2.25, 12.825, 1.125, "39.6", 39.6)
        |15.0 -> ("6", 6.0, 5.0, 15.0, 2.5, 14.25, 1.25, "44", 44.0)
        |18.0 -> ("7.2", 7.2, 6.0, 18.0, 3.0, 17.1, 1.5, "52.8", 52.8)
        |21.0 -> ("8.4", 8.4, 7.0, 21.0, 3.5, 19.95, 1.75, "61.6", 61.6)
        |60.0 -> ("24", 24.0, 20.0, 60.0, 10.0, 57.0, 5.0, "176", 176.0)
        |_ -> failwith "Error..."
